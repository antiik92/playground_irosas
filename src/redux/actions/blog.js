...
export const get_blog_list_page = (p) => async dispatch => {
    ...
    try{
        const res = await axios.get(`http://127.0.0.1:8000/api/blog/?p=${p}`, config);
...
export const get_blog_list_category = (category_id) => async dispatch => {
    ...
    try{
        const res = await axios.get(`http://127.0.0.1:8000/api/blog/category/${category_id}`, config);
...
export const get_blog_list_category_page = (category_id,p) => async dispatch => {
    ...
    try{
        const res = await axios.get(`127.0.0.1:8000/api/blog/category/${category_id}?p=${p}`, config);
...
export const get_blog = (slug) => async dispatch => {
    ...
    try {
        const res = await axios.get(`http://127.0.0.1:8000/api/blog/${slug}`, config);
...
export const search_blog = (search_term) => async dispatch => {
    ...
    try {
        const res = await axios.get(`http://127.0.0.1:8000/api//api/blog/search/${search_term}`, config);
